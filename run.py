...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='ImageMixer')
    ...
    args.model_type = 0 if args.model in ['ImageMixer', 'MV_DTSF'] else 1  # help='0 for image-based model, 1 for numerical-based model'
